...
function normalizeLibraryName(name: string): string {
  ...
  if (name.includes('스마트도서관')) {
    if (name === '광진구민체육센터스마트도서관') return '구민체육센터 스마트'
    if (name === '광진문화예술회관스마트도서관') return '문화예술회관 스마트'
    if (name === '어린이대공원역스마트도서관') return '어린이대공원 스마트'
...
const SMART_LIBRARY_COLORS: Record<string, string> = {
  ...
  '중곡스마트도서관': '#abe46e',
  '구의역스마트도서관': '#8bbeeb',
  '광진구민체육센터스마트도서관': '#8bbeeb',
  '광진문화예술회관스마트도서관': '#f4ac80',
  '어린이대공원역스마트도서관': '#f4ac80',
  '아차산역스마트도서관': '#abe46e',
}
